...
class _GIState extends State<S1> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: Center(child: Text('List absence S1 '))),
        drawer: Drawer(
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
 ...
 Future<void> getData() async {
  final response = await http.get(Uri.parse('http://10.0.2.2/api_data/api_chef/S1.php'));
